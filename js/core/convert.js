...
export function detectFormat(file) {
    ...
    if (shortcut) {
        throw new ConversionError(`A .${extension} file is only a link to a document stored in Google Drive, so there is nothing to convert. Open it in ${shortcut.app} and choose File → Download → ${shortcut.download}, then convert that file.`);
    }
